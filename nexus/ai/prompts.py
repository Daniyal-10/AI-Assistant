...
def build_fix_prompt(
    ...
    return (
        ...
        "2. ModuleNotFoundError → rewrite WITHOUT that module using stdlib\n"
        "3. ImportError for local module → fix the import path\n"
        "4. FileNotFoundError → generate the missing file\n"
        "5. socket/network error in tests → mock the HTTP call with unittest.mock.patch\n"
        "6. Wrong output or assertion → fix the logic\n"
